...
function cosineSimilarityBOW(a, b) {
    let dot = 0, na = 0, nb = 0;
 ...
 */
export function maxSimilarity(mutationText, recentLessons) {
 ...
 */
export function detectRegurgitation(mutationText, recentLessons, threshold = DEFAULT_REGURGITATION_THRESHOLD) {
    const sim = maxSimilarity(mutationText, recentLessons);
    return { regurgitated: sim >= threshold, maxSim: sim, threshold };
}
//# sourceMappingURL=RegurgitationDetector.js.map