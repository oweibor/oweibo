...
class SmokeTestStage {
    ...
    async execute(ctx) {
        ...
        const startResult = await sandbox.execute(`cd ${stagingPath} && npm install --production 2>&1 && node dist/index.js &`, 'bash');
...
exports.SmokeTestStage = SmokeTestStage;
//# sourceMappingURL=08b-smoke-test.stage.js.map