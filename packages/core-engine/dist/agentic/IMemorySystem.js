...
class UnifiedMemorySystem {
    ...
    compressor;
    logger;
    constructor(ltm, stm, warmer, compressor, logger) {
        this.ltm = ltm;
        this.stm = stm;
        this.warmer = warmer;
    ...
    async store(entry) {
        ...
        void this.ltm.store(ltmEntry).catch((err) => {
    ...
    reinforceMemory(memoryId, tenantId) {
        return this.ltm.reinforce(memoryId, tenantId);
    }
    penaliseMemory(memoryId, tenantId) {
