...
export const TENANT_CREATED_V1_SUBJECT = 'tenant.created.v1' as const;
...
export type TenantLifecycleEvent =
  | { readonly subject: typeof TENANT_CREATED_V1_SUBJECT; readonly payload: TenantCreatedV1Payload };
