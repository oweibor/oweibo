...
export interface RollbackContext {
    ...
    readonly invokedBy: {
        readonly type: RollbackInvokerType;
        readonly id: string;
    };
    /** Stable id for log correlation across orchestrator + adapter logs. */
    readonly correlationId: string;
}
export type RollbackResultState = 'fully_reverted' | 'partial' | 'no_op_already_reverted' | 'failed';
...
//# sourceMappingURL=IRollbackAdapter.d.ts.map