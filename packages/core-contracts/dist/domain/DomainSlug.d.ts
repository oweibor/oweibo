...
export type DomainMaturity = 'experimental' | 'beta' | 'general_availability' | 'deprecated';
/** Top-level domain grouping. */
export type DomainCategory = 'regulated' | 'professional' | 'technical' | 'creative';
/**
...
//# sourceMappingURL=DomainSlug.d.ts.map