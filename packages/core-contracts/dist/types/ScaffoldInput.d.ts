 ...
 */
export type HardwareProfile = 'n100_like' | 'n305' | 'celeron' | 'core_i3' | 'core_i5' | 'core_i7' | 'amd_low' | 'amd_mid' | 'amd_high' | 'arm64_rpi5' | 'arm64_server' | 'arm64_rk3588' | 'nvidia_small' | 'nvidia_medium' | 'nvidia_large' | 'nvidia_rtx' | 'apple_silicon';
/**
...
//# sourceMappingURL=ScaffoldInput.d.ts.map