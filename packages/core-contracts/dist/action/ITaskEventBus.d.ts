 ...
 */
export type ProposalDecisionKind = 'approved' | 'rejected' | 'expired' | 'auto_promoted_via_grant';
...
export interface ITaskEventBus {
     ...
     */
    subscribe(taskId: string, handler: (event: ProposalDecidedEvent) => void): () => void;
}
//# sourceMappingURL=ITaskEventBus.d.ts.map