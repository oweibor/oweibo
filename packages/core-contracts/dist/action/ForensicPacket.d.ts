 ...
 */
export type ForensicTriggerKind = 'manual' | 'auto_drift' | 'auto_rollback_failed' | 'auto_pattern' | 'compliance_request';
export type ForensicPacketState = 'open' | 'under_review' | 'resolved' | 'archived';
export type ForensicResolution = 'resumed' | 'overridden' | 'aborted' | 'lessons_learned';
/**
...
export declare const FORENSIC_PACKET_SCHEMA_VERSION = 1;
 ...
 */
export declare function severityToAutoTrigger(severity: 0 | 1 | 2 | 3): ForensicTriggerKind | null;
//# sourceMappingURL=ForensicPacket.d.ts.map