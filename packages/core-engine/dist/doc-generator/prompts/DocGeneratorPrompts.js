...
exports.GLOBAL_TOKEN_BUDGET = exports.PHASE_TOKEN_BUDGETS = exports.GETTING_STARTED_USER_PROMPT = exports.GETTING_STARTED_SYSTEM_PROMPT = exports.DEP_PURPOSE_USER_PROMPT = exports.DEP_PURPOSE_SYSTEM_PROMPT = exports.CONVENTIONS_USER_PROMPT = exports.CONVENTIONS_SYSTEM_PROMPT = exports.ADR_INFER_USER_PROMPT = exports.ADR_INFER_SYSTEM_PROMPT = exports.MODULE_DESC_USER_PROMPT = exports.MODULE_DESC_SYSTEM_PROMPT = exports.PROJECT_SUMMARY_USER_PROMPT = exports.PROJECT_SUMMARY_SYSTEM_PROMPT = exports.DOC_GEN_PHASES = void 0;
exports.DOC_GEN_PHASES = {
...
// ── Project Summary ───────────────────────────────────────────────────────────
exports.PROJECT_SUMMARY_SYSTEM_PROMPT = `
...
`.trim();
const PROJECT_SUMMARY_USER_PROMPT = (context) => `
Codebase:
${context}

Respond with the summary JSON only.
`.trim();
exports.PROJECT_SUMMARY_USER_PROMPT = PROJECT_SUMMARY_USER_PROMPT;
// ── Module Description ────────────────────────────────────────────────────────
exports.MODULE_DESC_SYSTEM_PROMPT = `
...
`.trim();
const MODULE_DESC_USER_PROMPT = (moduleName, apiContext) => `
Module: ${moduleName}
Public API:
${apiContext}
...
`.trim();
exports.MODULE_DESC_USER_PROMPT = MODULE_DESC_USER_PROMPT;
// ── ADR Inference ─────────────────────────────────────────────────────────────
exports.ADR_INFER_SYSTEM_PROMPT = `
...
`.trim();
const ADR_INFER_USER_PROMPT = (evidence) => `
Evidence:
${evidence}

Respond with a JSON array of inferred ADRs only.
`.trim();
exports.ADR_INFER_USER_PROMPT = ADR_INFER_USER_PROMPT;
// ── Convention Detection ──────────────────────────────────────────────────────
exports.CONVENTIONS_SYSTEM_PROMPT = `
...
`.trim();
const CONVENTIONS_USER_PROMPT = (context) => `
Code sample:
${context}

Respond with the conventions JSON array only.
`.trim();
exports.CONVENTIONS_USER_PROMPT = CONVENTIONS_USER_PROMPT;
// ── Dependency Purpose ────────────────────────────────────────────────────────
exports.DEP_PURPOSE_SYSTEM_PROMPT = `
...
`.trim();
const DEP_PURPOSE_USER_PROMPT = (packages) => `
Packages: ${packages.join(', ')}

Respond with JSON only.
`.trim();
exports.DEP_PURPOSE_USER_PROMPT = DEP_PURPOSE_USER_PROMPT;
// ── Getting Started ───────────────────────────────────────────────────────────
exports.GETTING_STARTED_SYSTEM_PROMPT = `
...
`.trim();
const GETTING_STARTED_USER_PROMPT = (context) => `
Codebase:
${context}

Write the Getting Started guide in markdown.
`.trim();
exports.GETTING_STARTED_USER_PROMPT = GETTING_STARTED_USER_PROMPT;
// ── Token budgets (per-phase caps in input tokens) ────────────────────────────
exports.PHASE_TOKEN_BUDGETS = {
...
exports.GLOBAL_TOKEN_BUDGET = 80_000;
//# sourceMappingURL=DocGeneratorPrompts.js.map