...
export declare class NoopVectorSearch implements IVectorSearch {
    search(_query: string, _topK: number): Promise<readonly VectorSearchHit[]>;
}
//# sourceMappingURL=IVectorSearch.d.ts.map