...
export type FireEvent = 'initial' | `escalation:${number}` | 'expiry' | 'decision';
...
export type DispatchStatus = 'sent' | 'delivered' | 'failed' | 'suppressed_quiet_hours';
...
//# sourceMappingURL=ApprovalSla.d.ts.map