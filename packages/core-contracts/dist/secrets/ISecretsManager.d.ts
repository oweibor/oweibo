...
export interface ISecretsManager {
    ...
    getLLMApiKey(provider: 'ollama' | 'openai' | 'anthropic'): Promise<Readonly<Record<string, string>>>;
    getInfraCredentials(service: 'qdrant' | 'traefik' | 'k3s' | 'langfuse' | 'otel' | 'sandbox'): Promise<Readonly<Record<string, string>>>;
}
//# sourceMappingURL=ISecretsManager.d.ts.map