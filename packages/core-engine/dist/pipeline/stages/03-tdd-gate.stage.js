...
class TDDGateStage {
    ...
    async execute(ctx) {
        ...
        const result = await sandbox.execute(`cd ${workspacePath} && npx jest --no-coverage --passWithNoTests --testTimeout=30000 2>&1`, 'bash');
...
exports.TDDGateStage = TDDGateStage;
//# sourceMappingURL=03-tdd-gate.stage.js.map