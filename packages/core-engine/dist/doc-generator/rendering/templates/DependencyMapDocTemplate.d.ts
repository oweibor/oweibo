...
export declare class DependencyMapDocTemplate implements IDocTemplate {
    readonly category: "dependency-map";
...
//# sourceMappingURL=DependencyMapDocTemplate.d.ts.map