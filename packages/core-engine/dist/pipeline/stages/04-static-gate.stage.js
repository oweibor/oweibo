...
exports.StaticGateStage = void 0;
class StaticGateStage {
    name = 'static-gate';
    async execute(ctx) {
        ...
        try {
            ...
            logger.warn('[Stage 04] ESLint output not valid JSON.');
        }
        // 3. Secret scanning
...
exports.StaticGateStage = StaticGateStage;
//# sourceMappingURL=04-static-gate.stage.js.map