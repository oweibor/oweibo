...
exports.GENERAL_CODING_PROMPTS = void 0;
exports.getGeneralCodingPromptNames = getGeneralCodingPromptNames;
exports.getGeneralCodingPrompt = getGeneralCodingPrompt;
/** All named prompts for the general-coding path */
exports.GENERAL_CODING_PROMPTS = {
...
function getGeneralCodingPromptNames() {
    return Object.keys(exports.GENERAL_CODING_PROMPTS);
}
/** Retrieve a bundled general-coding prompt by name */
function getGeneralCodingPrompt(name) {
    return exports.GENERAL_CODING_PROMPTS[name];
}
