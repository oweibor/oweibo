...
// Re-export ActionClass for downstream so `ActionTimeRuleContext` types
// resolve without a separate import path. (Otherwise ActionClass is
// only referenced from this module's types below.)
