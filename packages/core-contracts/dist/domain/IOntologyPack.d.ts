...
export type NamedEntityType = 'regulator' | 'institution' | 'standard' | 'product' | 'protocol' | 'framework';
...
export interface IOntologyPackRegistry {
     ...
     */
    getDisambiguation(slug: DomainSlug, term: string, contextTokens: readonly string[]): DisambiguationResult | undefined;
...
//# sourceMappingURL=IOntologyPack.d.ts.map